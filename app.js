...
const cleaningRoutes = require("./routes/orderRoute");
const personalRoutes = require("./routes/customerRoute");
const sequelize = require("./util/database");

app.use("/cleaningInfo", cleaningRoutes);
app.use("/personalInfo", personalRoutes);
